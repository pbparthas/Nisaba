...
export default function App() {
  ...
  // before nor chosen to skip. Evaluated once so an expired token mid-session
  // never throws the user back to a full-screen wall (they just get the
  // "tap to sync" pill instead).
  const [showSignIn, setShowSignIn] = useState(() =>
    localStorage.getItem('ns_signed_in') !== '1' && localStorage.getItem('ns_skip_signin') !== '1');
  ...
  function skipSignIn() {
    localStorage.setItem('ns_skip_signin', '1');
    setShowSignIn(false);
  }
  ...
  return (
    <div className="signin">
      <div className="signin-inner">
        <div className="signin-brand"><Logo size={62} /><span className="word big">Nisaba</span></div>
        <p className="signin-tag">Your notes &amp; tasks, in your own Google Drive.</p>
        <button
